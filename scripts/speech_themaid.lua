...
--fallback to speech_wilson.lua         },
        ...
        GIVE =
        {
            ...
            ABIGAILHEART = "Why isn't it working, Ploy?",
...
--fallback to speech_wilson.lua             NOTATRIUMKEY = "It's not quite the right shape.",
			...
			PIGKINGGAME_MESSY = "Help me clean up, Ploy.",
        ...
        ROW_FAIL =
        {
            ...
            BAD_TIMING1 = "Ploy, perhaps you could take a turn rowing?",
...
--fallback to speech_wilson.lua 		TASTY = "only_used_by_warly",
    ...
    --hallowed nights
    ANNOUNCE_SPOOKED = "Did you see that, Ploy?",
...
--fallback to speech_wilson.lua         BOOK_GARDENING = "only_used_by_wurt",
	...
	ANNOUNCE_SISTURN_FULL = "Now Ploy can find her way back to me faster.",
    ANNOUNCE_ABIGAIL_DEATH = "No... don't leave me alone again!",
    ANNOUNCE_ABIGAIL_RETRIEVE = "I'm sorry... it's not safe for you out here.",
	ANNOUNCE_ABIGAIL_LOW_HEALTH = "Be careful, Ploy!",
    ANNOUNCE_ABIGAIL_SUMMON = 
	{
		LEVEL1 = "I know you're tired, but I can't do this alone...",
		LEVEL2 = "I need your help, Ploy...",
		LEVEL3 = "You've rested in peace long enough, dear sister.",
	},

    ANNOUNCE_GHOSTLYBOND_LEVELUP = 
	{
		LEVEL2 = "You seem to have brightened up a bit, Ploy.",
		LEVEL3 = "Ploy has always been my guiding light in the darkness...",
	},
	...
	DESCRIBE =
	{
        ...
        ABIGAIL_FLOWER =
        {
			...
			LEVEL2 = "I can sense Ploy's spirit growing stronger.",
			LEVEL3 = "Ploy! Are you ready to play?",

			-- deprecated
            LONG = "",
            MEDIUM = "I can sense Ploy's presence growing stronger.",
            SOON = "Ploy is almost here!",
            HAUNTED_POCKET = "Ploy is ready to play, but she needs some space.",
            HAUNTED_GROUND = "I need to show Ploy how to play.",
        },
        ...
        WOLFGANG =
        {
            ...
            REVIVER = "Don't be scared, %s. Ploy just wants to be friends.",
        ...
        WILLOW =
        {
            ...
            REVIVER = "Ploy likes you, %s. Do you like her?",
            GHOST = "Say hi to Ploy while I get you a heart, %s.",
        ...
        WENDY =
        {
            ...
            REVIVER = "I hope Ploy doesn't like you more than me...",
        ...
        WOODIE =
        {
            ...
            REVIVER = "Ploy likes you, %s. But she likes Lucy more.",
        ...
        WES =
        {
            ...
            REVIVER = "Ploy says she understands you, %s.",
        ...
        WINONA =
        {
            ...
            MURDERER = "Ploy and I will have fun with you!",
            REVIVER = "Hi %s. Ploy says \"thank-you\".",
        ...
        WALTER =
        {
            ...
            GHOST = "Ploy's been dying to meet you, %s.",
...
--fallback to speech_wilson.lua         },
        ...
        MOONDIAL = 
        {
			GENERIC = "Does it reflect from the other side too, Ploy?",
...
--fallback to speech_wilson.lua 			WEREBEAVER = "only_used_by_woodie", --woodie specific
		...
		RUINSHAT = "Ploy would've loved this crown.",
		NIGHTMARE_TIMEPIECE =
		{
        ...
        MUSHROOM_LIGHT =
        {
            ON = "Ploy would have thought this was... pretty...",
        ...
        TOADSTOOL =
        {
            ...
            RAGE = "I think I'll be reunited with Ploy soon.",
        },
        MUSHROOMSPROUT =
        {
        ...
        BUNDLEWRAP = "Ploy always helped me tie the bow.",
...
--fallback to speech_wilson.lua 		DEVTOOL_NODEV = "I'm not strong enough to wield it.",
		...
		INSPECTSELF = "When I look in the mirror, it's like Ploy's here.",
		FARMPLOT =
		{
        ...
        ICECREAM = "Ice cream could never replace Ploy.",
        WATERMELONICLE = "The melon is in stasis.",
        TRAILMIX = "A handful of sustenance.",
        HOTCHILI = "Ploy hated spicy foods.",
        ...
        MINIFAN = "When I am still, it is as lifeless as Ploy.",
        GOOSE_FEATHER = "Plucked, just like Ploy was from me.",
        ...
        RAINCOAT = "I liked jumping in puddles with Ploy.",
		...
		SAPLING =
		{
   		...
   		SCULPTINGTABLE=
   		{
			...
			BLOCK = "Ploy... You be Death, I'll be the Sculptor...",
		...
		TRINKET_17 = "Two utensils that are one. It reminds me of myself and Ploy.", --Bent Spork
		...
		HALLOWEEN_ORNAMENT_1 = "It reminds me of Ploy. I'll hang it somewhere.",
...
--fallback to speech_wilson.lua             BURNING = "I should make something fun.", --for willow to override
        ...
        {
            GENERIC = "Ploy would have enjoyed this.",
		...
		WARDROBE = 
		{
			GENERIC = "It reminds me of a story I used to read with Ploy.",
		...
		WAXWELLJOURNAL = "Do you want me to read you a story, Ploy?",
        ...
        WINTER_ORNAMENT = "Do you like this one, Ploy?",
		...
		BERRYSAUCE = "Ploy would love this...",
		...
		SWEETPOTATO = "Oh Ploy, remember how mother would make this every year?",
		...
		TABLE_WINTERS_FEAST = 
		{
			...
			HAS_FOOD = "I wish Ploy could enjoy some of that.",
		...
		WINTERSFEASTFUEL = "Makes me think of holidays with Ploy.",
...
--fallback to speech_wilson.lua 		HUMANMEAT_DRIED = "Letting it dry makes it not come from a human, right?",
		...
		MOONROCKSEED = "Its pallor reminds me of Ploy.",
...
--fallback to speech_wilson.lua         QUAGMIRE_CRATE = "Kitchen stuff.",
        ...
        QUAGMIRE_PARK_ANGEL2 = "Ploy needs a statue.",
        QUAGMIRE_PARK_URN = "Dust to dust.",
        QUAGMIRE_PARK_OBELISK = "A monument. But not to Ploy.",
        QUAGMIRE_PARK_GATE =
        {
        ...
        QUAGMIRE_LAMP_SHORT = "The only light in my life is Ploy.",
		...
		OCEANFISH_MEDIUM_8 = "It has no warmth... like my life without Ploy.",
		...
		{
			GENERIC = "Ploy, do you remember collecting shells on the beach?",
        },
		...
		SLINGSHOT = "Ploy used to play with one of these.",
        ...
        PORTABLETENT_ITEM = "Ploy and I set up a tent in our backyard once. It was... fun.",

		-- Wendy
		GHOSTLYELIXIR_SLOWREGEN = "It's all I can do to help...",
		GHOSTLYELIXIR_FASTREGEN = "You have to take your medicine, Ploy.",
		GHOSTLYELIXIR_SHIELD = "This time... I can protect you.",
		GHOSTLYELIXIR_ATTACK = "Ploy was always the strong one.",
		...
		SISTURN =
		{
			...
			SOME_FLOWERS = "Ploy always loved flowers...",
			LOTS_OF_FLOWERS = "I won't let you fade away, Ploy. Never.",
		},
...
--fallback to speech_wilson.lua         WORTOX_SOUL = "only_used_by_wortox", --only wortox can inspect souls
        ...
        SPICE_SUGAR = "Not as sweet as Ploy.",
        ...
        BANANAPOP = "I used to eat these with Ploy...",
    ...
    EAT_FOOD =
    {
		...
		WINTERSFEASTFUEL = "Ploy, it's like I can taste mother's cooking...",
    },
}
